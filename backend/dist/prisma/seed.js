...
const VEHICLES = [
    {
        ...
        description: 'Magnifique BMW Série 3 2021 en excellent état, entretien suivi, carnet complet. Idéale pour un usage quotidien haut de gamme.',
        year: 2021, price: 9800, currency: 'EUR', mileage: 24000,
        fuelType: client_1.FuelType.DIESEL, transmission: client_1.TransmissionType.AUTOMATIC, condition: client_1.VehicleCondition.USED,
    ...
    },
    {
        ...
        description: 'BMW M4 Competition, moteur 6 cylindres bi-turbo 510 ch, pack carbone, échappement M Performance. Un pur bloc de sensations.',
        year: 2022, price: 9500, currency: 'EUR', mileage: 12500,
        fuelType: client_1.FuelType.PETROL, transmission: client_1.TransmissionType.AUTOMATIC, condition: client_1.VehicleCondition.USED,
        ...
        isFeatured: true, status: client_1.VehicleStatus.PUBLISHED,
    },
    {
        slug: 'mercedes-classe-s-580-2022',
        title: 'Mercedes-Benz Classe S 580 4MATIC 2022',
        description: 'Le summum du luxe allemand : suspension pneumatique, sièges massants, intérieur cuir Nappa. Livrée d’usine complète.',
        year: 2022, price: 9900, currency: 'CHF', mileage: 18000,
        fuelType: client_1.FuelType.HYBRID, transmission: client_1.TransmissionType.AUTOMATIC, condition: client_1.VehicleCondition.USED,
    ...
    },
    {
        ...
        description: 'SUV premium 7 places, toit panoramique, système MBUX, jantes 21". Parfait équilibre entre confort et prestance.',
    ...
    },
    {
        ...
        description: 'Icône intemporelle. Boîte PDK, Sport Chrono, échappement sport. Entretien exclusivement chez Porsche Centre.',
    ...
    },
    {
        ...
        description: 'Transmission intégrale, capote électrique, sièges sport plus. Le plaisir de conduire à ciel ouvert sur la Côte d’Azur.',
    ...
    },
    {
        ...
        description: 'Le SUV le plus véloce de sa catégorie : 571 ch, freins céramique, suspension pneumatique adaptative.',
    ...
    },
    {
        ...
        description: 'Le break le plus rapide du marché : V8 biturbo 600 ch, quattro, freins carbo-céramique. Performance et praticité.',
    ...
    },
    {
        ...
        description: 'Berline 100% électrique, 476 ch, recharge rapide 270 kW, direction dynamique. L’élégance silencieuse.',
        year: 2023, price: 8200, currency: 'EUR', mileage: 6200,
        fuelType: client_1.FuelType.ELECTRIC, transmission: client_1.TransmissionType.AUTOMATIC, condition: client_1.VehicleCondition.USED,
    ...
    },
    {
        ...
        description: 'Suspension pneumatique active, intérieur cuir Windsor, système Meridian. Le raffinement britannique tout-terrain.',
    ...
    },
    {
        ...
        description: 'V8 biturbo 670 ch, châssis en aluminium, aérodynamique active. Une supercar mythique en parfait état, carnet Ferrari complet.',
    ...
    },
    {
        ...
        description: 'Grand tourisme élégant, V8 620 ch, ligne intemporelle signée Centro Stile Ferrari. Livrée neuve, garantie constructeur.',
        year: 2022, price: 9800, currency: 'EUR', mileage: 3100,
        fuelType: client_1.FuelType.PETROL, transmission: client_1.TransmissionType.AUTOMATIC, condition: client_1.VehicleCondition.CERTIFIED_PRE_OWNED,
    ...
    },
    {
        ...
        description: 'La berline électrique la plus rapide au monde : 0 à 100 km/h en 2,1 s, autonomie 600 km, Autopilot complet.',
    ...
    },
    {
        ...
        description: 'SUV électrique 6 places, portes Falcon Wing, autonomie 560 km. Technologie et espace au service de la famille.',
    ...
    },
    {
        ...
        description: 'Grand tourisme britannique par excellence : cuir cousu main, boiseries précieuses, W12... pardon, V8 550 ch de couple souverain.',
    ...
    },
    {
        ...
        description: 'Le SUV ultra-luxe : suspension active Bentley Dynamic Ride, intérieur sur-mesure, finition Azure. Prestige absolu.',
    ...
    },
    {
        ...
        description: 'La référence des compactes sportives : moteur 2.0 TSI 230 ch, châssis affûté, finition GTI reconnaissable entre mille. Entretien complet, carnet à jour.',
        year: 2018, price: 9200, currency: 'EUR', mileage: 68000,
        fuelType: client_1.FuelType.PETROL, transmission: client_1.TransmissionType.MANUAL, condition: client_1.VehicleCondition.USED,
    ...
    },
    {
        ...
        description: 'Citadine moderne et économique, faible kilométrage, garantie constructeur restante. Idéale pour un premier achat malin.',
    ...
    },
    {
        ...
        description: 'SUV familial maintes fois primé, finition GT, toit panoramique, i-Cockpit digital. Un excellent rapport prestations/prix.',
    ...
    },
    {
        ...
        description: 'Break hybride ultra fiable, consommation réduite, garantie Toyota étendue. La sérénité au quotidien.',
    ...
    },
    {
        ...
        description: 'Berline sportive 280 ch, châssis ST, freins renforcés. Pour les amateurs de sensations à petit budget.',
    ...
    },
    {
        ...
        description: 'Citadine récente, faible kilométrage, garantie constructeur active. Économique et agréable à conduire au quotidien.',
    ...
    },
    {
        ...
        description: 'Monospace compact spacieux et confortable, idéal pour la famille. Bien équipé, entretien à jour.',
        year: 2018, price: 6900, currency: 'EUR', mileage: 72000,
        fuelType: client_1.FuelType.DIESEL, transmission: client_1.TransmissionType.MANUAL, condition: client_1.VehicleCondition.USED,
    ...
    },
    {
        ...
        description: 'Break diesel increvable, grand volume de coffre, entretien rigoureux. Le choix malin des gros rouleurs.',
    ...
    },
    {
        ...
        description: 'Cabriolet citadin plein de charme, toit ouvrant électrique, faible kilométrage. Parfait pour rouler cheveux au vent.',
    ...
    },
    {
        ...
        description: 'SUV compact polyvalent, diesel économique, très bon état général. Un classique toujours plébiscité.',
...
async function main() {
    ...
    const [superAdminRole, adminRole, sellerRole, buyerRole] = await Promise.all([client_1.RoleName.SUPER_ADMIN, client_1.RoleName.ADMIN, client_1.RoleName.SELLER, client_1.RoleName.BUYER].map((name) => prisma.role.upsert({ where: { name }, update: {}, create: { name } })));
