...
export function CreateListing() {
  ...
  const handleSubmit = async (values: VehicleFormValues) => {
    ...
    try {
      ...
      toast.error("Impossible de publier l'annonce. Vérifiez les champs du formulaire.");
    } finally {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <h1 className="mb-2 text-2xl font-bold text-slate-900 dark:text-white">Publier une annonce</h1>
      <p className="mb-6 text-sm text-slate-500 dark:text-slate-400">
        Votre annonce sera visible publiquement après validation par un administrateur.
      </p>

      <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
        <VehicleForm onSubmit={handleSubmit} submitLabel="Publier l'annonce" isSubmitting={isSubmitting}>
          <div>
